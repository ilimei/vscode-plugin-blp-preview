import bounds from "mdx-m3-viewer/dist/cjs/viewer/bounds";
...
export class GridInstance extends ModelInstance {
    ...
    renderOpaque(): void {
        ...
        // gl.blendFuncSeparate(gl.SRC_ALPHA, gl.SRC_ALPHA);
        // gl.blendFunc(gl.SRC_ALPHA, gl.SRC_ALPHA);
        // console.info('ONE_MINUS_SRC_ALPHA', gl.ONE_MINUS_SRC_ALPHA, gl.ONE_MINUS_SRC_COLOR, gl.ONE)
        // console.info(gl.getParameter(gl.BLEND_SRC_RGB), gl.getParameter(gl.BLEND_SRC_ALPHA),
        //  gl.getParameter(gl.BLEND_DST_RGB), gl.getParameter(gl.BLEND_DST_ALPHA));
...
export class Grid extends Model {
    ...
    constructor(viewer: ModelViewer) {
        ...
        console.info(gl.getExtension("OES_standard_derivatives"))
        console.info(viewer.gl.getParameter(viewer.gl.SHADING_LANGUAGE_VERSION));
