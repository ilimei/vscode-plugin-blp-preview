import { EventEmitter } from "./addEvent";
...
export class Scrollable extends IDisposable {
    ...
    public readonly events = {
        scroll: new EventEmitter<ScrollEvent>(),
    };
	...
	private _setState(newState: ScrollState, inSmoothScrolling: boolean): void {
		...
		this.events.scroll.fire(this._state.createScrollEvent(oldState, inSmoothScrolling));
	}
}
