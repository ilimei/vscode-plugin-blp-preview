...
import { ITooltipMarkdownString, setupCustomHover, setupNativeHover } from '../../../browser/ui/iconLabel/iconLabelHover';
...
export class IconLabel extends Disposable {
	...
	private setupHover(htmlElement: HTMLElement, tooltip: string | ITooltipMarkdownString | undefined): void {
		...
		if (!this.hoverDelegate) {
			...
			if (hoverDisposable) {
				this.customHovers.set(htmlElement, hoverDisposable as any);
			}
		}
	}
