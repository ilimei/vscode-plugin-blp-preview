...
import { Orientation, Sash } from '../../../browser/ui/sash/sash';
import { DistributeSizing, ISplitViewStyles, IView as ISplitView, LayoutPriority, Sizing, SplitView } from '../../../browser/ui/splitview/splitview';
...
export { Orientation } from '../../../browser/ui/sash/sash';
export { LayoutPriority, Sizing } from '../../../browser/ui/splitview/splitview';
...
class BranchNode implements ISplitView<ILayoutContext>, IDisposable {
	...
	constructor(
		...
		this.splitviewSashResetDisposable = onDidSashReset(this._onDidSashReset.fire as any, this._onDidSashReset);
