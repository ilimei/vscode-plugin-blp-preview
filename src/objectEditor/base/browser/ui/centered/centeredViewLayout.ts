...
import { IView, IViewSize } from '../../../browser/ui/grid/grid';
import { IBoundarySashes } from '../../../browser/ui/grid/gridview';
import { ISplitViewStyles, IView as ISplitViewView, Orientation, SplitView } from '../../../browser/ui/splitview/splitview';
...
function toSplitViewView(view: IView, getHeight: () => number): ISplitViewView<{ top: number; left: number }> {
	return {
		...
		onDidChange: Event.map<{ width: number }, any>(view.onDidChange as any, e => e && e.width),
