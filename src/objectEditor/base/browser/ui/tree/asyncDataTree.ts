...
import { IIdentityProvider, IListDragAndDrop, IListDragOverReaction, IListVirtualDelegate } from '../../../browser/ui/list/list';
import { ElementsDragAndDropData } from '../../../browser/ui/list/listView';
import { IListStyles } from '../../../browser/ui/list/listWidget';
import { ComposedTreeDelegate, TreeFindMode as TreeFindMode, IAbstractTreeOptions, IAbstractTreeOptionsUpdate } from '../../../browser/ui/tree/abstractTree';
import { ICompressedTreeElement, ICompressedTreeNode } from '../../../browser/ui/tree/compressedObjectTreeModel';
import { getVisibleState, isFilterResult } from '../../../browser/ui/tree/indexTreeModel';
import { CompressibleObjectTree, ICompressibleKeyboardNavigationLabelProvider, ICompressibleObjectTreeOptions, ICompressibleTreeRenderer, IObjectTreeOptions, IObjectTreeSetChildrenOptions, ObjectTree } from '../../../browser/ui/tree/objectTree';
import { IAsyncDataSource, ICollapseStateChangeEvent, ITreeContextMenuEvent, ITreeDragAndDrop, ITreeElement, ITreeEvent, ITreeFilter, ITreeMouseEvent, ITreeNode, ITreeRenderer, ITreeSorter, TreeError, TreeFilterResult, TreeVisibility, WeakMapper } from '../../../browser/ui/tree/tree';
...
export class AsyncDataTree<TInput, T, TFilterData = void> implements IDisposable, IThemable {
	...
	get options(): IAsyncDataTreeOptions<T, TFilterData> {
		return this.tree.options as any as IAsyncDataTreeOptions<T, TFilterData>;
	}
